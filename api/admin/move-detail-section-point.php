...
/**
 * POST /api/admin/move-detail-section-point.php
 *
 * Simple point ordering: swaps one "kenmerk" card with its previous/next
...
$repository->movePoint((int) $point['section_id'], $pointId, $direction);
