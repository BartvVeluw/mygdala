...
/**
 * POST /api/admin/create-website-language.php
 *
 * Registers a new website language (code, English name, native name). It
 * starts OFF: nothing is published in a language nobody has translated yet,
 * and switching it on is a separate, deliberate step.
 *
...
try {
    SiteLanguages::add($code, $name, $nativeName);
} catch (\InvalidArgumentException $e) {
    website_language_redirect($e->getMessage());
} catch (\Throwable $e) {
    error_log('[api/admin/create-website-language.php] ' . $e->getMessage());
