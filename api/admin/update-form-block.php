...
$fields = [
    'form_id' => $formId,
    'title_nl' => mb_substr(trim((string) ($_POST['title_nl'] ?? '')), 0, 255),
    'title_en' => mb_substr(trim((string) ($_POST['title_en'] ?? '')), 0, 255),
    'intro_nl' => mb_substr(trim((string) ($_POST['intro_nl'] ?? '')), 0, 1000),
    'intro_en' => mb_substr(trim((string) ($_POST['intro_en'] ?? '')), 0, 1000),
...
if ($errors !== []) {
    ...
    $_SESSION['admin_form_block_old'] = $fields + ['form_id' => (string) ($formId ?? '')];
