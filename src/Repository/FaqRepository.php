...
class FaqRepository extends Repository
{
    ...
    /**
     * Stores the order of the questions of one FAQ section as the one-form
    ...
    {
        $stmt = $this->db->prepare(
            'UPDATE faq_items SET sort_order = :sort_order, updated_at = NOW() WHERE id = :id AND faq_section_id = :parent_id'
        );
