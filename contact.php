...
$page = \App\Service\PageContent::forContentKey('contact');
...
\App\Service\SectionRegistry::collectPageAssets('contact');
...
<main id="main">
  ...
  <?php else: ?>
    <?php \App\Service\SectionRegistry::renderPage('contact', \App\Service\Breadcrumbs\PageBreadcrumb::forPage($page)); ?>
  <?php endif; ?>
