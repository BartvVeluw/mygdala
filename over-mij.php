...
$page = \App\Service\PageContent::forContentKey('over-mij');
...
\App\Service\SectionRegistry::collectPageAssets('over-mij');
...
<main id="main">
  ...
  <?php else: ?>
    <?php \App\Service\SectionRegistry::renderPage('over-mij', \App\Service\Breadcrumbs\PageBreadcrumb::forPage($page)); ?>
  <?php endif; ?>
