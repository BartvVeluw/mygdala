...
<main class="admin-main">
  <p class="admin-text-muted"><a href="/admin/page.php?id=<?= (int) $page['id'] ?>">&larr; <?= htmlspecialchars($section['page_label'], ENT_QUOTES, 'UTF-8') ?></a></p>
  ...
  <section class="admin-card">
    <h2>Zichtbaarheid</h2>
    <p class="admin-text-muted">Deze sectie heeft geen eigen titel/introtekst — alleen de items hieronder zijn zichtbaar. Animatiesnelheid en vormgeving staan vast in het thema.</p>
    <form method="post" action="/api/admin/update-marquee-section.php" class="admin-product-form">
      ...
      <label class="admin-checkbox-label">
        ...
        Actief (uitgevinkt = deze sectie — alle items — wordt niet getoond op de pagina)
      </label>
  ...
  <section class="admin-card">
    ...
    <?php if ($items === []): ?>
      <p class="admin-text-muted">Nog geen items in deze sectie.</p>
    <?php endif; ?>
