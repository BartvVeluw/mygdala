...
<title><?= $h(SectionRegistry::label('project_cards')) ?> <?= admin_t('block_projects.admin', ['v1' => $h((string) $page['title'])]) ?></title>
<link rel="stylesheet" href="<?= \App\Service\AssetVersion::url('/admin/assets/admin.css') ?>">
</head>
<body<?= \App\Service\AdminTheme::bodyAttribute() ?>>
<?php require __DIR__ . '/_header.php'; ?>
<main class="admin-main">
  <p class="admin-text-muted"><a href="/admin/page.php?id=<?= (int) $page['id'] ?>"><?= admin_t('block_projects.back', ['v1' => $h((string) $page['title'])]) ?></a></p>
  <h1><?= $h(SectionRegistry::label('project_cards')) ?></h1>
  <p class="admin-text-muted"><?= admin_t('block_projects.intro', ['v1' => $h((string) $page['title'])]) ?></p>
