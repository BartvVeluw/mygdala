...
| **Portfolio** | Portfolio-items, categorieën, afbeeldingen, detailpagina. Een uitschakelbare module die op een nieuwe installatie standaard **uit** staat | `Module\PortfolioModule`, `PortfolioGalleryContent`, `PortfolioGalleryRepository`, `PortfolioCategoryRepository`, `PortfolioItemImageRepository`, `PortfolioImageProcessor`, `portfolio.php`, `portfolio-detail.php`, `admin/portfolio.php`, `admin/portfolio-item.php` — zie `MODULES.md` |
