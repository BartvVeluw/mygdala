...
| **Formulieren** | Formulierdefinities, velden en hun breedte, publieke verwerking, meldingen, bewaarde inzendingen, het voorbeeld in de editor | `Service\Forms\*` (o.a. `FormFieldWidth`), `FormRepository`, `FormSubmissionRepository`, `partials/form.php`, `api/form-submit.php`, `admin/forms.php`, `admin/form.php`, `admin/form-preview.php`, `admin/form-submissions.php` — zie `FORMS.md` |
